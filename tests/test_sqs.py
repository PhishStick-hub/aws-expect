...
class TestSQSToHaveMessage:
    ...
    def test_returns_message_when_body_matches(self, sqs_queue):
    ...
    def test_raises_timeout_when_wrong_body_present(self, sqs_queue):
    ...
    def test_message_remains_visible_after_non_matching_poll(self, sqs_queue):
        sqs_queue.send_message(MessageBody="wrong")
    ...
    def test_returns_correct_message_from_batch(self, sqs_queue):
    ...
    def test_succeeds_when_message_appears_mid_poll(self, sqs_queue):
        def send_later() -> None:
...
class TestSQSToConsumeMessage:
    ...
    def test_non_matching_message_restored_and_matching_consumed(self, sqs_queue):
    ...
    def test_only_matching_message_deleted_from_batch(self, sqs_queue):
